...
<div id="menu_htfff">
  ...
  ************************************************************************************************************************
  -->
    ...
    <div id="menu">
    <ul>
      <li<?php if ($nomFicPhpCourant[0]=="/index.php") {?> class="active"<?php }?>><a href="index.php" class="info"> Proponer <span>Presenta tu equipo para que podamos detectar los mejores potenciales</span></a></li>
      <li<?php if ($nomFicPhpCourant[0]=="/dtn_u20age.php") {?> class="active"<?php }?>><a href="dtn_u20age.php" class="info"> U20|Edad m&aacute;xima <span>Identifica el &uacute;ltimo partido que pueden disputar tu jugadores en la selecci&oacute;n U20</span></a></li>
      <li<?php if ($nomFicPhpCourant[0]=="/dtn_requirement.php") {?> class="active"<?php }?>><a href="dtn_requirement.php" class="info"> Requisitos <span>Nivel m&iacute;nimo para entrar en la base de datos de la DTN </span></a></li>
      <li<?php if ($nomFicPhpCourant[0]=="/fff_help.php") {?> class="active"<?php }?>><a href="fff_help.php" class="info"> B&uacute;squeda de Entrenadores <span>Inscríbete para recibir propuestas de recuperaciones de potenciales internacionales</span></a></li>
      <li<?php if ($nomFicPhpCourant[0]=="/contact.php" || $nomFicPhpCourant[0]=="/dtn_members.php" || $nomFicPhpCourant[0]=="/fff_federation.php") {?> class="active"<?php }?>><a href="contact.php" class="sous_menu"> Contacto </a>
        <ul>
          <li><a href="http://www.htfff.free.fr/dtn/forum"> Foro </a></li>
          <li><a href="dtn_members.php" class="info"> Miembros <span>Lista de los miembros de la DTN</span></a></li>
          <li><a href="fff_federation.php"> DTN </a></li>
        </ul>
      </li>
      <li<?php if ($nomFicPhpCourant[0]=="/links.php") {?> class="active"<?php }?>><a href="links.php"> Enlaces &uacute;tiles </a></li>
    </ul>
    </div>
    <?php
/*
...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  ************************************************************************************************************************
  ...
  <tr><td width="30" height="6"><img src="img/lang_06_spacer.gif" width="30" height="6" /></td></tr>
  <tr><td width="30" height="25"><a href="setlang.php?language=fr<?=$redir?>"><img src="img/lang_10_it.gif" alt="it" title="it" width="30" height="25" border="0" /></a></td></tr>
  <tr><td width="30" height="6"><img src="img/lang_06_spacer.gif" width="30" height="6" /></td></tr>
