...
define("OBJECTIF_IIIHELP","Das Ziel des iiiHelp Projekt ist einfach : <strong>Manager zu finden, die bereit sind, die besten Potenzielle und aktuelle franz&ouml;sische Nationalspieler zu &uuml;bernehmen</strong>, und die fr&uuml;h oder spät verkauft werden. Fals Sie interessiert sind, sind Sie hier zu Hause.");

define("CRITERE_IIIHELP","Sie k&ouml;nnen sich sicher vorstellen, dass wir gewisse Anspr&uuml;che haben, wie zum Beispiel das Trainerniveau (gut|7) und die Anzahl an Co-Trainern. Aber die Basis einer Zusammenarbeit ist Ihr Wille, HT-Frankreich zur Hilfe zu kommen. Sie denken dieses Projekt ist für Sie geeignet? <strong>Tragen Sie sich ein.</strong>");

define("MODE_EMPLOI_IIIHELP","<b>Bedienungsanleitung</b> : Die E-mail Adresse erm&ouml;glicht, Sie zu informieren, wenn ein Spieler, der Ihren Erwartungen entspricht zum Verkauf steht.");

define("POUR_LES_IIIHELP","f&uuml;r die");

define("ENTRAINEMENT_SOUHAITE_IIIHELP","Gew&uuml;nschtes Training");

define("AGE_MOINS20_IIIHELP","17-20 j&auml;hrigen");

define("AGE_PLUS20_IIIHELP","21 j&auml;hrigen und &auml;lter");

define("COMMENTAIRE_IIIHELP","Kommentare : (nicht obligatorisch)");

define("FIN_OK_IIIHELP","Wir haben Ihren Eintrag in Anspruch genommen, Sie werden eine e-mail bekommen, fals ein entsprechender Spieler zum Verkauf steht.");
...
define("LISTE_AUCUN_IIIHELP","keine");

define("LISTE_CF_IIIHELP","Standardsituationen");

define("LISTE_DEF_IIIHELP","Verteidigung");

define("LISTE_BUT_IIIHELP","Chancenverwertung");

define("LISTE_WING_IIIHELP","Flankenl&auml;ufe");

define("LISTE_PASS_IIIHELP","Passspiel");

define("LISTE_PM_IIIHELP","Spielaufbau");

define("LISTE_GK_IIIHELP","Torwart");

define("ENTETE_FORMULAIRE_IIIHELP","Anmeldungsformular &iexcl;&iexcl;&iexcl;help!");
...
define("TEXTE_BOUTON_AUTORISATION","Analyse des Teams erlauben");

define("SESS_ACTIVE","Angemeldet bleiben");

define("EXPLICATION_SESS_ACTIVE","Wenn Sie einen Hacken setzen, werden die Informationen &uuml;ber Ihr Hattrickteam bei Ihrem n&auml;chsten Besuch automatisch angezeigt (wenn Sie die Cookies nicht gelöscht haben). So brauchen Sie sich dann nicht mehr bei Hattrick zu identifizieren. Nicht ratsam wenn Sie von einem &ouml;ffentlichen Ort aus eingeloggt sind !");

define("MESSAGE_BIENVENUE","Wilkommen !");

define("NON_CONNECTE","Nicht eingeloggt");

define("INFOBULLE_NON_CONNECTE","Sie m&uuml;ssen die Analyse Ihres Teams in Hattrick erlauben um die Informationen &uuml;ber Ihre franz&ouml;sischen Spieler sehen zu k&ouml;nnen. ");

define("CONNECTE","Eingeloggt : ");
