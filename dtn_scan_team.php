...
$teamID2 = $_SESSION['HT']->getSecondaryTeam();
if ($teamID2 != null)
{

  // Récupération de la liste des joueurs
  $list_joueur_HT = getDataMesJoueursFromHT_usingPHT($_SESSION['HT']->getSecondaryTeam()->getTeamId());
  $teamID2 = $_SESSION['HT']->getSecondaryTeam()->getTeamId();
  ...
  /*      GESTION AFFICHAGE LISTE JOUEURS                                       */
  /******************************************************************************/
  $nomeq2 = $_SESSION['HT']->getSecondaryTeam()->getTeamName();
