...
// Ver:		$Id: jpgraph.php,v 1.2 2005/07/30 18:12:20 gtanguy Exp $
//
...
// Must end with '/'
 DEFINE("CACHE_DIR","/www/www.ht-fff.org/dtn/interface/graph/tmp/");


// Directory for jpGraph TTF fonts. Must end with '/'
 // DEFINE("TTF_DIR","/home/asseonli/www/projet/Admin/graph/fonts/");
...
//
include "/www/www.ht-fff.org/dtn/interface/graph/jpgraph_gradient.php";
...
function GenImgName() {
	...
	$HTTP_SERVER_VARS=$_SERVER;   //added     $supported = imagetypes();
...
require_once "/www/www.ht-fff.org/dtn/interface/graph/jpgraph_plotmark.inc";
//==============================================================================
