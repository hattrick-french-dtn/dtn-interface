        ...
        <?php if (isset($_REQUEST['ht_posteAssigne'])) {
          ...
          <?php if ($_REQUEST['ht_posteAssigne']==-1) {
				...
				echo $ht_posteAssigne;
                    ...
                    <br />sous peine de doubler ses effets sans possibilit&eacute; de retour en arrière...
                    <br />Vous devez v&eacute;rifier que les DTNs+ ont bien fait leur M&agrave;J via l'onglet d&eacute;di&eacute; avant de lancer.</font></div>
                    <br />
