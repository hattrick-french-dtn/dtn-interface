<?php
	...
	function html_top_banner() {
		...
		if ( !is_blank( $t_page ) && file_exists( $t_page ) && !is_dir( $t_page ) ) {
			...
			echo '<a href="http://www.ht-fff.org" title="DTN Bugtracker"><img border="0" alt="Mantis Bugtracker" src="http://www.ht-fff.org/dtn/forum/templates/subSilver/images/logo_phpBB.gif" /></a>';
